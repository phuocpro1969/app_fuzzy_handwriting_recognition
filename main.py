...
warningsTextId=warnings.create_text(100, 50, fill="black", font=('Helvetica 15 bold'))
warnings.pack()
...
training=tk.Button(frame, bg="#263D42", fg="white", text="Train model", padx=10, pady=5, command=train)
training.pack(padx=5, pady=5, side=tk.LEFT)

runApps=tk.Button(frame, bg="#263D42", fg="white", text="Predict Images", padx=10, pady=5, command=predict)
...
answerCanVasId=answerCanVas.create_text(250, 50, fill="black", font=('Helvetica 15 bold'))
answerCanVas.pack()
